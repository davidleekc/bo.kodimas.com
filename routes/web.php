...
Route::get('/home', [App\Http\Controllers\HomeController::class, 'getProfile'])->name('home');

// Profile Routes
Route::prefix('profile')->name('profile.')->middleware(['auth', 'verified'])->group(function(){
    Route::get('/', [HomeController::class, 'getProfile'])->name('detail')->middleware('verified');
    Route::post('/update', [HomeController::class, 'updateProfile'])->name('update')->middleware('verified');
    Route::post('/change-password', [HomeController::class, 'changePassword'])->name('change-password')->middleware('verified');
});
