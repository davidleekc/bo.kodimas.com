            ...
            <div class="col-md-9 border-right">
                ...
                <div class="p-3 py-5">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-4">
                                <label class="labels">Channel User ID</label><br />
                                <span class="font-weight-bold">{{ auth()->user()->channel_user_id }}</span>
                            </div>
                            <div class="col-md-4">
                                <label class="labels">Nomber ID</label><br />
                                <span class="font-weight-bold">{{ auth()->user()->id_no }}</span>

                            </div>
                            <div class="col-md-4">
                                <label class="labels">Tarikh Lahir</label>
                                <input min="1920-01-01" max="2001-12-31 @error('dob') is-invalid @enderror" name="dob" id="dob" type="date" class="form-control" value="{{ old('dob') ? old('dob') : auth()->user()->dob }}" placeholder=""/>
                                @error('mobile_number')
