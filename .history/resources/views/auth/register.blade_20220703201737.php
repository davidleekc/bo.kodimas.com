                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-outline">
                                            ...
                                            <select class="select form-control form-control-lg" id="idType" name="id_type"  value="{{ old('id_type') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-outline">
                                            ...
                                            <input type="text" id="idNo" name="id_no" class="form-control form-control-lg" value="{{ old('id_no') }}" required/>
                                        </div>
