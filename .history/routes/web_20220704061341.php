...
Route::prefix('profile')->name('profile.')->middleware(['auth', 'verified'])->group(function(){
    Route::get('/', [HomeController::class, 'getProfile'])->name('profile')->middleware('verified');
    Route::post('/update', [HomeController::class, 'updateProfile'])->name('profile.update')->middleware('verified');
